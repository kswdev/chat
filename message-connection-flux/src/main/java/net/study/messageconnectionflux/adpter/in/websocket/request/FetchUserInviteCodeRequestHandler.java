...
import net.study.messageconnectionflux.application.dto.kafka.FetchUserInviteCodeRequestRecord;
import net.study.messageconnectionflux.application.dto.websocket.inbound.FetchUserInviteCodeRequest;
...
public class FetchUserInviteCodeRequestHandler implements BaseRequestHandler<FetchUserInviteCodeRequest> {
    ...
    @Override
    public Mono<Void> handleRequest(WebSocketSession senderSession, FetchUserInviteCodeRequest request) {
        ...
        return eventProducer.sendRequest(
                ...
                () -> clientNotificationService.sendError(requestUserId, new ErrorResponse(MessageType.FETCH_USER_INVITE_CODE_REQUEST, "fetch user invite code failed.")));
    }
    @Override
