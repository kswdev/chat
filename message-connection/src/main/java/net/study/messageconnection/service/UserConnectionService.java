...
import net.study.messageconnection.dto.projection.InviterUserIdProjection;
import net.study.messageconnection.dto.projection.UserConnectionStatusProjection;
import net.study.messageconnection.dto.projection.UserIdUsernameInviterUserIdProjection;
import net.study.messageconnection.entity.user.UserEntity;
import net.study.messageconnection.entity.user.connection.UserConnectionEntity;
import net.study.messageconnection.repository.connection.UserConnectionRepository;
