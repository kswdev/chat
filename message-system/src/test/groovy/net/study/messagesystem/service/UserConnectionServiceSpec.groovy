...
class UserConnectionServiceSpec extends Specification {
    ...
    def "사용자 연결 신청에 대한 테스트"() {
        ...
        'Reject Invited'      | new UserId(1) | 'userA'        | new UserId(2) | 'userB'        | new InviteCode('user2Code') | new InviteCode('user2Code') | UserConnectionStatus.REJECTED     | Pair.of(Optional.empty(), "Already Invited to " + targetUsername);
